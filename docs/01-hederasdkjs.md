...
- after a deployment, take the copied contract ID, and tell this script to use it
...
In the final line above, we do one extra thing:
save the public key that corresponds to this operator account as `operatorPublicKey`.
This will come in handy in subsequent steps.
